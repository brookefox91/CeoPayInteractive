function check(){
	...
	if (question1 == "Ameriprise Financial") {
		document.getElementById("message").innerHTML = "James Cracchiolo has quite a few spending choices after drawing $23.9 million last year - "+pay+" times your take and 223 times Ameriprise's median annual pay of $107,082 in 2017.";
	}
	if (question1 == "Bank Of America") {
		document.getElementById("message").innerHTML = "Brian Moynihan has weathered more than a few board room scraps. Maybe that's why they paid him $21.8 million last year, "+pay+" times your pay and 250 times the firm median of $87,115 in 2017.";
	}
	if (question1 == "Bank Of New York Mellon") {
	...
	if (question1 == "State Street") {
		document.getElementById("message").innerHTML = "If you had Joseph Hooley's job you would have made $19.5 million last year. But you don't - he made "+pay+" times more than you and 229 times State Street's median pay, which was $85,322 in 2017.";
	}
	if (question1 == "Citigroup") {
	...
	if (question1 == "Wells Fargo & Company") {
		document.getElementById("message").innerHTML = "Few would envy Timothy Sloan's job right now. Wells Fargo is fighting on all fronts, giving him ample opportunity to prove he's worth the $17.6 million he earned last year, "+pay+" times your wages and 291 times the Wells Fargo median, which was $60,466 in 2017.";
	}
	if (question1 == "Invesco") {
	...
	if (question1 == "Northern Trust") {
		document.getElementById("message").innerHTML = "Rick Waddell's decision to join Northern Trust straight from college in 1975 has well and truly paid off. After 35 years at the firm he netted $11.9 million in compensation last year, "+pay+" times your pay and 169 times the firm median, which was $70,029 in 2017.";
	}
	if (question1 == "T. Rowe Price") {
		document.getElementById("message").innerHTML = "Ever wonder what you would you do with $11.7 million? That's what T. Rowe Price CEO William Stromberg earned last year, "+pay+" times your pay and 121 times the $1 trillion firm's median pay, which was $96,190 in 2017.";
	}
	if (question1 == "Federated Investors") {
		document.getElementById("message").innerHTML = "The Federated Investors chief executive hauled in $5.2 million last year, "+pay+" times your pay and 58 times the $397 billion firm's median pay, which was $90,049 in 2017.";
	}
	if (question1 == "SEI Investments") {
		document.getElementById("message").innerHTML = "He founded the firm 50 years ago and last year SEI Investments CEO Alfred West earned himself $2 million in total compensation, "+pay+" times what you make and 24 times the $85,285 median pay for the Oaks, Pennsylvania-based firm.";
	}
